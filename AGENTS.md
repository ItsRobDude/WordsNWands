...
For high-level product identity and experience goals, use `README.md` as the operational entry point and `docs/project-identity.md` for identity philosophy and design intent.
